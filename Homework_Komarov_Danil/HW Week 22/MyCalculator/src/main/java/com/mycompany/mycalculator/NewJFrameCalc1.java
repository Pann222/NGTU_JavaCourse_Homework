 ...
 * @author Dan20
 */
public class NewJFrameCalc1 extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrameCalc1
     */
    public NewJFrameCalc1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonDivis = new javax.swing.JButton();
        ...
        jLDisplay.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLDisplay.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLDisplay.setText("0");
        jLDisplay.setToolTipText("");
        jLDisplay.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 2));
        jLDisplay.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButtonDivis.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButtonDivis.setText("/");
        jButtonDivis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonDivisActionPerformed(evt);
            }
        });

        jButtonMult.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButtonMult.setText("*");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButtonDivis, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButtonEquals, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLDisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton0, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButtonDivis, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButtonEqualsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEqualsActionPerformed
        ...
        jLDisplay.setText("" + (action1.actM(oper1,Integer.parseInt(jLDisplay.getText()))));
        } 
        catch(DevideByZeroException ex) {
              jLDisplay.setText("" + ex.getMessage());
 //           JOptionPane.showMessageDialog(jLDisplay,"You cannot devide by zero.");
        } finally {
        result = true;
        oper1=0;
        }
    ...
    private void jButtonMultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMultActionPerformed
        // TODO add your handling code here:
        action1 = Oper1Enum.MULT;
        oper1= Integer.parseInt(jLDisplay.getText());
        jLDisplay.setText("0");
    }//GEN-LAST:event_jButtonMultActionPerformed

    private void jButtonDivisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDivisActionPerformed
        // TODO add your handling code here:
        action1 = Oper1Enum.DIVIS;
        oper1= Integer.parseInt(jLDisplay.getText());
        jLDisplay.setText("0");
    }//GEN-LAST:event_jButtonDivisActionPerformed
    ...
    private void setDisplayText(String numButton){
    if (jLDisplay.getText().equals("0") || jLDisplay.getText().equals("")
            ||result == true){
        jLDisplay.setText(numButton);
        result = false;
        } else {
            jLDisplay.setText(jLDisplay.getText() + numButton);
        }
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFrameCalc1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFrameCalc1().setVisible(true);
    ...
    private int oper1 = 0;
    private Oper1Enum action1 = Oper1Enum.PLUS; 
    ...
    private javax.swing.JButton jButtonDivis;
